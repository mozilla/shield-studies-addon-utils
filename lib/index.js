...
var Study = Class({
  ...
  cleanup: function () {
    return this.variationsMod.cleanup();
  },
});


function handleStartup (startupOptions, aStudy) {
  return aStudy.start(startupOptions.loadReason);
}

function handleOnUnload (reason, aStudy) {
  return aStudy.shutdown(reason);
}
